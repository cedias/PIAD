...
public class NearDupesMemTask implements Runnable {
	...
	public NearDupesMemTask(ArrayList<LettersCount> reviews,final int index, UpdateReviews up, int window,double simil) {
